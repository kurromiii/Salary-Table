...
public class Salary implements Serializable {
    ...
    //10,000<x<100,000
    @Column(name = "salary_basic_hourly_pay", columnDefinition = "NUMBER(7)")
    ...
    //حقوق پایه روزانه
    //100,000<x<1,000,000
    @Column(name = "salary_basic_daily_pay", columnDefinition = "NUMBER(8)")
    @NotNull(message = "Should Not Be Null")
    ...
    @Column(name = "salary_basic_monthly_pay", columnDefinition = "NUMBER(9)")
    @NotNull(message = "Should Not Be Null")
    ...
    //100,000<x<1,000,000
    @Column(name = "salary_working_year_pay", columnDefinition = "NUMBER(8)")
    @NotNull(message = "Should Not Be Null")
    ...
    //500,000<x<5,000,000
    @Column(name = "salary_pay_for_each_child", columnDefinition = "NUMBER(8)")
    @NotNull(message = "Should Not Be Null")
    ...
    //300,000<x<5,000,000
    @Column(name = "salary_married_people_rights", columnDefinition = "NUMBER(8)")
    @NotNull(message = "Should Not Be Null")
